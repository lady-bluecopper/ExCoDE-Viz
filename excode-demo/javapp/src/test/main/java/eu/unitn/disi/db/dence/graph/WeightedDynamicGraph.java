...
public class WeightedDynamicGraph extends DynamicGraph {
    ...
    public WeightedDynamicGraph(int numNodesLeft, int numNodesRight, int numEdges, int snapshots, int numEdgesPerSnap) { 
        super(numNodesLeft, numNodesRight, numEdges, snapshots, numEdgesPerSnap);
        this.edges = Lists.newArrayList();
    }
